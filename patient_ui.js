...
var PatientUI = {
    ...
    /**
     * 1行分のHTML生成 (引数にindexを使わずpのidのみ利用)
     * @param {object} p 患者データオブジェクト
     */
    generateRowHtml: function(p) {
        ...
        h += '<td class="hide-on-print" style="font-size:11px;">' + escapeHtml(p.dept || '') + '</td>';
        h += '<td class="hide-on-print" style="font-size:11px;">' + escapeHtml(p.doctor || '') + '</td>';
